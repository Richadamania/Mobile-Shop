...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtFirstName" runat="server" height="22px" OnTextChanged="txtFirstName_TextChanged" style="z-index: 1; left: 163px; top: 94px; position: absolute; width: 225px; margin-left: 63px"></asp:TextBox>
        <p style="height: 31px">
        ...
        <asp:TextBox ID="txtAddress" runat="server" height="22px" style="z-index: 1; left: 150px; top: 166px; position: absolute; width: 225px; margin-left: 76px"></asp:TextBox>
        <p>
